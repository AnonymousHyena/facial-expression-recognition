...
def fc(enco):
	...
	den1 = Dense(16, activation='relu',kernel_regularizer=regularizers.l2(0.008))(drop0)
	drop1 = Dropout(rate=0.6)(den1)

	den2 = Dense(7, activation='relu', kernel_regularizer=regularizers.l2(0.008))(drop1)
